...
import com.black.libcommon.data.BaseEvent;
import com.black.libcommon.data.StatusError;
import com.black.libutils.RvViewUtils;
...
public abstract class BlackFragment extends Fragment implements
    ...
    protected void setToolbar(String title) {
        try {
            mToolbar = (Toolbar) mRootView.findViewById(com.black.libcommon.R.id.toolbar);
            mTvTitle = (TextView) mRootView.findViewById(com.black.libcommon.R.id
                    .tv_toolbar_title);
            mTvTitle.setText(title);
            mToolbar.setTitle("");
            mToolbar.setTitleTextColor(Color.WHITE);
            StatusBarUtil.setColor(mActivity, ContextCompat.getColor(mActivity, com.black.libcommon.R
                    .color.colorPrimary), 0);
            ((AppCompatActivity) getActivity()).setSupportActionBar(mToolbar);
            ((AppCompatActivity) getActivity()).getSupportActionBar().setDisplayHomeAsUpEnabled
                    (true);
            mToolbar.setNavigationIcon(com.black.libcommon.R.mipmap.ic_home_back);
        } catch (Exception e) {
